function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'super_drain_note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'super_drain_note'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'super_drain_note' then
